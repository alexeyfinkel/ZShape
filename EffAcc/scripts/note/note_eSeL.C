...
void note_eSeL(TFile* f0, TFile* f1){
  ...
  TH1* u0=f1->Get("myanalyzer/cutNoCuts/NoCutseSeL")->Clone("rw1");
  ...
  c0->GetXaxis()->SetTitle("E_{short}/E_{long}");
  ...
  tl->Draw("SAME");
  zrap_Prelim(.75,.8);
  c1->Print("/home/grad/klapoetke/public_html/cmsdoc/PHD/trunk/figs/fig_esel.eps");
