...
void note_e9e25(TFile* f0, TFile* f1){
  ...
  TH1* u0=f1->Get("myanalyzer/cutNoCuts/NoCutse9e25")->Clone("rw1");
  c0->Scale(u0->GetEntries()/c0->GetEntries()); //n0->Scale(da->GetEntries()/n0->GetEntries());
  gStyle->SetOptStat(0000);
  gStyle->SetOptFit(1111);
    
  c0->GetYaxis()->SetTitle("");
  c0->GetXaxis()->SetTitle("E_{3x3}/E_{5x5}");
  ...
  tl->Draw("SAME");
  zrap_Prelim(.75,.8);
c1->Print("/home/grad/klapoetke/public_html/cmsdoc/PHD/trunk/figs/fig_e9e25.eps");
  }
