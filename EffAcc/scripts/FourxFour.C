...
//.x ../scripts/FourxFour.C("mcEff/EE-HF/C08-m(60,120)/Z0_at_MC","mcEff/EE-HF/C08-m(60,120)/wZ0_at","mcEff/EE-HF/C08-m(60,120)/Z0_at_MC","mcEff/EE-HF/C08-m(60,120)/wZ0_at",_file0,_file1,_file2,_file3,_file4,_file5,_file6)


//.x ../scripts/FourxFour.C("mcEff/EE-HF/C08-m(60,120)/Z0_at_MC","mcEff/EE-HF/C08-m(60,120)/wZ0_at","mcEff/EE-HF/C08-m(60,120)/wZ0_phiStar_MC","mcEff/EE-HF/C08-m(60,120)/wZ0_phiStar",_file0,_file1,_file2,_file3,_file4,_file5,_file6)



void FourxFour(const char* name1R,const char* name1TL,const char* name2R,const char* name2TL,TFile* f1,TFile* f2,TFile* f3,TFile* f4,TFile* f5,TFile* f6,TFile* f7/*,TFile* f8,TFile* f9*/){
 ...
 h2[0]->GetXaxis()->SetTitle("P_{T} [GeV]");
  ...
  t2->SetFillStyle(0);
  t2->AddEntry(h1[0],"Parp[91]=3","l");
  t2->AddEntry(h1[1],"Parp[91]=4","l");
  t2->AddEntry(h1[2],"Parp[91]=5","l");
  t2->AddEntry(h1[3],"Parp[91]=6","l");
  t2->AddEntry(h1[4],"Parp[91]=7","l");
  t2->AddEntry(h1[5],"Parp[91]=8","l");
  t2->AddEntry(h1[6],"Parp[91]=9","l");
  //t2->AddEntry(h1[7],"Parp[91]=");
  //t2->AddEntry(h1[8],"Parp[91]=");
  t2->Draw();
  ...
  t3->SetFillStyle(0);
  t3->AddEntry(h1[0],"Parp[91]=3","l");
  t3->AddEntry(h1[1],"Parp[91]=4","l");
  t3->AddEntry(h1[2],"Parp[91]=5","l");
  t3->AddEntry(h1[3],"Parp[91]=6","l");
  t3->AddEntry(h1[4],"Parp[91]=7","l");
  t3->AddEntry(h1[5],"Parp[91]=8","l");
  t3->AddEntry(h1[6],"Parp[91]=9","l");
  //t3->AddEntry(h1[7],"Parp[91]=");
  //t3->AddEntry(h1[8],"Parp[91]=");
  t3->Draw();
  ...
  t4->SetFillStyle(0);
  t4->AddEntry(h1[0],"Parp[91]=3","l");
  t4->AddEntry(h1[1],"Parp[91]=4","l");
  t4->AddEntry(h1[2],"Parp[91]=5","l");
  t4->AddEntry(h1[3],"Parp[91]=6","l");
  t4->AddEntry(h1[4],"Parp[91]=7","l");
  t4->AddEntry(h1[5],"Parp[91]=8","l");
  t4->AddEntry(h1[6],"Parp[91]=9","l");
  //t4->AddEntry(h1[7],"Parp[91]=");
  //t4->AddEntry(h1[8],"Parp[91]=");
  t4->Draw();
