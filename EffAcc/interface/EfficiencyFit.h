#ifndef EFFFITNEW_INC
#define EFFFITNEW_INC
...
class EfficiencyFit {
 ...
 public:
  ...
  EfficiencyFit();
  //EfficiencyFit(TFile * file);
  EfficiencyFit(TFile *file, std::string EffName ="", std::string EffType = "", bool doSig  = true, bool doBkg = true);
  //EfficiencyFit(TFile *file, std::string EffName ="");
  EfficiencyFit(const std::string & sigtextFileName = "0", const std::string & bkgtextFileName = "0" );
