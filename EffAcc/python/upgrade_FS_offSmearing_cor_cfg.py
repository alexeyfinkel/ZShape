...
#cfb 5 upgrade_FS_smearOn_cor_cfg.py ~/Feb2021_fullSim_zee.list ;cfb 5 upgrade_FS_offSmearing_cor_cfg.py ~/Feb2021_fullSim_zee.list   
#process.p = cms.Path(process.makePatElectrons+process.f2s)
process.p = cms.Path(process.hfEMClusteringSequence+process.f2s+process.mcEff)
