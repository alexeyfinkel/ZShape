...
process.hfRecoEcalCandidate.intercept2DCut = cms.double(-99)
process.hfRecoEcalCandidate.intercept2DSlope = cms.double(-99)
process.hfRecoEcalCandidate.e9e25Cut = cms.double(-99)
