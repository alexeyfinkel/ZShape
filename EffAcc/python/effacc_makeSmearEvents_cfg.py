...
process.SMEAR = cms.OutputModule("PoolOutputModule",
  dataset = cms.untracked.PSet(dataTier = cms.untracked.string('SMEAR')),
  fileName = cms.untracked.string('SMEAREDsTUFF.root'),
  outputCommands = cms.untracked.vstring("keep *")

)

process.outpath = cms.EndPath(process.SMEAR)
