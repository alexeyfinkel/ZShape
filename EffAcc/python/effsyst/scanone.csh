...
foreach mypy (`ls |grep ${mytype}`)
 #   ~/bin/condor_filelist.perl $mypy ../apr11Powheg.txt 10
# ~/bin/condor_filelist.perl $mypy ../aprZ2.txt 10
# ~/bin/condor_filelist.perl $mypy ../aprD6T.txt 10 
 ~/bin/condor_filelist.perl $mypy ../mayP0.txt 10
# ~/bin/condor_filelist.perl $mypy ../mayProPT0.txt 10
# ~/bin/condor_filelist.perl $mypy ../mayProQ20.txt 10
    sleep 20s
end
