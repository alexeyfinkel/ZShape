...
process.FullSimSmearedElectronsProducer.HF.constantp = cms.double(0.1001)
process.FullSimSmearedElectronsProducer.HF.constantm = cms.double(0.1001)
process.FullSimSmearedElectronsProducer.HF.constantp2 = cms.double(0.1001)
process.FullSimSmearedElectronsProducer.HF.constantm2 = cms.double(0.1001)
process.FullSimSmearedElectronsProducer.EB.c = cms.double(0.1)
process.FullSimSmearedElectronsProducer.EE.c = cms.double(0.1)
