...
// Class:      MCAnalyTrial
// 
/**\class MCAnalyTrial MCAnalyTrial.cc ZShape/MCAnalyTrial/src/MCAnalyTrial.cc
...
class MCAnalyTrial : public edm::EDAnalyzer {
public:
  explicit MCAnalyTrial(const edm::ParameterSet&);
  ~MCAnalyTrial();
