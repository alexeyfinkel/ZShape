...
//root /local/cms/user/jmmans/zshape_jun23/zshape_effacc_base_z2_jun23.root ~jmmans/work/zshape/ZFD*_mar3.root
void ZZmassPlotBkg(TFile* sigf, TFile* zfd_bkgd, TFile* zfd_final) {
  setTDRStyle();
  const double weight=1.0/(1771);
  char name[200];
  //sprintf(name,"ZFromData/ECAL80-ECAL95/C07-HLT-GSF/Z0_mass");
  ...
  // sprintf(name,"mcEff/ECAL80-ECAL95/C07-HLT-GSF/Z0_mass");
  ...
  TLegend* tl=new TLegend(0.64,0.35,0.91,0.55);
  tl->SetFillStyle(0);
  ...
  //s2->SetMaximum(2700);//ecal-ecal
  s2->SetMaximum(190);//hf
 ...
 zrap_Prelim(0.88,0.91);


 zrap_Lumi(0.38,0.91,36);



 //c2->Print("~/public_html/talk/Z_CompareFINAL_ECAL80-ECAL95_mee_bkgd.eps"); 
 //c2->Print("~/public_html/talk/Z_CompareFINAL_ECAL80-ECAL95_mee_bkgd.C");

   c2->Print("~/public_html/talk/Z_CompareFINAL_ECAL80-HF_mee_bkgd.eps"); 
   c2->Print("~/public_html/talk/Z_CompareFINAL_ECAL80-HF_mee_bkgd.C");
