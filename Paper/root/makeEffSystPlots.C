...
TFile *my95    = new TFile("/local/cms/user/klapoetke/Z2Pow_apr/Z2EcalEffSystECAL80-ECAL95Def_WP95_001.root");
TFile *my95hf  = new TFile("/local/cms/user/klapoetke/Z2Pow_apr/Z2EcalEffSystECAL80-ECAL95Def_WP95_001.root");
TFile *myo95p  = new TFile("WP95P.root","RECREATE");
TFile *myo95m  = new TFile("WP95M.root","RECREATE");

TFile *my80    = new TFile("/local/cms/user/klapoetke/Z2Pow_apr/Z2EcalEffSystECAL80-ECAL95Def_WP80_001.root");
...
TFile *myGSF   = new TFile("/local/cms/user/klapoetke/Z2Pow_apr/Z2EcalEffSystECAL80-ECAL95Def_GsfTrack-EtaDet_001.root");
...
TFile *mySC    = new TFile("/local/cms/user/klapoetke/Z2Pow_apr/Z2EcalEffSystECAL80-ECAL95Def_Supercluster-Eta_001.root");
...
TFile *myHLT   = new TFile("/local/cms/user/klapoetke/Z2Pow_apr/Z2EcalEffSystECAL80-ECAL95Def_HLT-GSF_001.root");
...
plotEffSyst(my95,my95hf,myo95p, "Z0_Y", "Plus");
myo95p->Write();
plotEffSyst(my95,my95hf,myo95m, "Z0_Y", "Minus");
myo95m->Write();
plotEffSyst(my80,my80hf, myo80p, "Z0_Y", "Plus");
myo80p->Write();
plotEffSyst(my80,my80hf, myo80m, "Z0_Y", "Minus");
myo80m->Write();
plotEffSyst(myGSF,myGSFhf, myoGSFp, "Z0_Y", "Plus");
myoGSFp->Write();
plotEffSyst(myGSF,myGSFhf, myoGSFm, "Z0_Y", "Minus");
myoGSFm->Write();
plotEffSyst(myHFEID,myHFEIDhf,myoHFEIDp, "Z0_Y", "Plus");
myoHFEIDp->Write();
plotEffSyst(myHFEID,myHFEIDhf,myoHFEIDm, "Z0_Y", "Minus");
myoHFEIDm->Write();
plotEffSyst(myHFSC,myHFSChf,myoHFSCp, "Z0_Y", "Plus");
myoHFSCp->Write();
plotEffSyst(myHFSC,myHFSChf,myoHFSCm, "Z0_Y", "Minus");
myoHFSCm->Write();
plotEffSyst(mySC,mySChf,myoSCp, "Z0_Y", "Plus");
myoSCp->Write();
plotEffSyst(mySC,mySChf,myoSCm, "Z0_Y", "Minus");
myoSCm->Write();
plotEffSyst(myHLT,myHLThf,myoHLTp, "Z0_Y", "Plus");
myoHLTp->Write();
plotEffSyst(myHLT,myHLThf,myoHLTm, "Z0_Y", "Minus");
myoHLTm->Write();
plotEffSyst(myNT,myNThf,myoNTp, "Z0_Y", "Plus");
myoNTp->Write();
plotEffSyst(myNT,myNThf,myoNTm, "Z0_Y", "Minus");
myoNTm->Write();
myoNTm->Close();
