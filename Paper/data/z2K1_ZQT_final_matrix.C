{
//=========Macro generated from canvas: finalz2K1_ZQT/finalz2K1_ZQT
//=========  (Wed Jun 22 14:38:09 2011) by ROOT version5.28/00d
   TCanvas *finalz2K1_ZQT = new TCanvas("finalz2K1_ZQT", "finalz2K1_ZQT",0,0,800,600);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   finalz2K1_ZQT->SetHighLightColor(2);
   finalz2K1_ZQT->Range(-0.6198982,-0.01417621,2.956996,0.07443138);
   finalz2K1_ZQT->SetFillColor(0);
   finalz2K1_ZQT->SetBorderMode(0);
   finalz2K1_ZQT->SetBorderSize(2);
   finalz2K1_ZQT->SetLogx();
   finalz2K1_ZQT->SetTickx(1);
   finalz2K1_ZQT->SetTicky(1);
   finalz2K1_ZQT->SetLeftMargin(0.13);
   finalz2K1_ZQT->SetRightMargin(0.05);
   finalz2K1_ZQT->SetTopMargin(0.05);
   finalz2K1_ZQT->SetBottomMargin(0.16);
   finalz2K1_ZQT->SetFrameFillStyle(0);
   finalz2K1_ZQT->SetFrameLineWidth(2);
   finalz2K1_ZQT->SetFrameBorderMode(0);
   finalz2K1_ZQT->SetFrameFillStyle(0);
   finalz2K1_ZQT->SetFrameLineWidth(2);
   finalz2K1_ZQT->SetFrameBorderMode(0);
   ...
   tvis->SetBinContent(1,0.0245661);
   tvis->SetBinContent(2,0.05519114);
   tvis->SetBinContent(3,0.05647393);
   tvis->SetBinContent(4,0.04593645);
   tvis->SetBinContent(5,0.03557687);
   tvis->SetBinContent(6,0.02778909);
   tvis->SetBinContent(7,0.02213628);
   tvis->SetBinContent(8,0.0180193);
   tvis->SetBinContent(9,0.01165765);
   tvis->SetBinContent(10,0.00624561);
   tvis->SetBinContent(11,0.0036788);
   tvis->SetBinContent(12,0.001879864);
   tvis->SetBinContent(13,0.0007935914);
   tvis->SetBinContent(14,0.0003624776);
   tvis->SetBinContent(15,0.0001432999);
   tvis->SetBinContent(16,4.793382e-05);
   tvis->SetBinContent(17,1.55668e-05);
   tvis->SetBinContent(18,1.239851e-06);
   tvis->SetBinContent(19,1.153091e-09);
   tvis->SetEntries(19);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   finalz2K1_ZQT->Modified();
   finalz2K1_ZQT->cd();
   finalz2K1_ZQT->SetSelected(finalz2K1_ZQT);
}
