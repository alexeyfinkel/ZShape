{
//=========Macro generated from canvas: finalK1_ZQTLog/finalK1_ZQTLog
//=========  (Wed Jun 22 14:40:20 2011) by ROOT version5.28/00d
   TCanvas *finalK1_ZQTLog = new TCanvas("finalK1_ZQTLog", "finalK1_ZQTLog",0,0,800,600);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   finalK1_ZQTLog->SetHighLightColor(2);
   finalK1_ZQTLog->Range(-0.6198982,-6.981287,2.956996,-0.8482436);
   finalK1_ZQTLog->SetFillColor(0);
   finalK1_ZQTLog->SetBorderMode(0);
   finalK1_ZQTLog->SetBorderSize(2);
   finalK1_ZQTLog->SetLogx();
   finalK1_ZQTLog->SetLogy();
   finalK1_ZQTLog->SetTickx(1);
   finalK1_ZQTLog->SetTicky(1);
   finalK1_ZQTLog->SetLeftMargin(0.13);
   finalK1_ZQTLog->SetRightMargin(0.05);
   finalK1_ZQTLog->SetTopMargin(0.05);
   finalK1_ZQTLog->SetBottomMargin(0.16);
   finalK1_ZQTLog->SetFrameFillStyle(0);
   finalK1_ZQTLog->SetFrameLineWidth(2);
   finalK1_ZQTLog->SetFrameBorderMode(0);
   finalK1_ZQTLog->SetFrameFillStyle(0);
   finalK1_ZQTLog->SetFrameLineWidth(2);
   finalK1_ZQTLog->SetFrameBorderMode(0);
   ...
   truth log->SetBinContent(1,0.03473407);
   truth log->SetBinContent(2,0.05803429);
   truth log->SetBinContent(3,0.05035022);
   truth log->SetBinContent(4,0.04179582);
   truth log->SetBinContent(5,0.03391722);
   truth log->SetBinContent(6,0.02715676);
   truth log->SetBinContent(7,0.02192764);
   truth log->SetBinContent(8,0.01783559);
   truth log->SetBinContent(9,0.01160055);
   truth log->SetBinContent(10,0.006239438);
   truth log->SetBinContent(11,0.003679084);
   truth log->SetBinContent(12,0.001879671);
   truth log->SetBinContent(13,0.000793453);
   truth log->SetBinContent(14,0.0003616535);
   truth log->SetBinContent(15,0.0001442802);
   truth log->SetBinContent(16,4.856131e-05);
   truth log->SetBinContent(17,1.568039e-05);
   truth log->SetBinContent(18,1.231318e-06);
   truth log->SetBinContent(19,1.238777e-09);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   finalK1_ZQTLog->Modified();
   finalK1_ZQTLog->cd();
   finalK1_ZQTLog->SetSelected(finalK1_ZQTLog);
}
