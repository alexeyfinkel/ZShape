{
//=========Macro generated from canvas: finalK1Z2_ZQT/finalK1Z2_ZQT
//=========  (Fri Jun 24 13:15:45 2011) by ROOT version5.28/00d
   TCanvas *finalK1Z2_ZQT = new TCanvas("finalK1Z2_ZQT", "finalK1Z2_ZQT",0,0,800,600);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   finalK1Z2_ZQT->SetHighLightColor(2);
   finalK1Z2_ZQT->Range(-0.6198982,-0.01417621,2.956996,0.07443138);
   finalK1Z2_ZQT->SetFillColor(0);
   finalK1Z2_ZQT->SetBorderMode(0);
   finalK1Z2_ZQT->SetBorderSize(2);
   finalK1Z2_ZQT->SetLogx();
   finalK1Z2_ZQT->SetTickx(1);
   finalK1Z2_ZQT->SetTicky(1);
   finalK1Z2_ZQT->SetLeftMargin(0.13);
   finalK1Z2_ZQT->SetRightMargin(0.05);
   finalK1Z2_ZQT->SetTopMargin(0.05);
   finalK1Z2_ZQT->SetBottomMargin(0.16);
   finalK1Z2_ZQT->SetFrameFillStyle(0);
   finalK1Z2_ZQT->SetFrameLineWidth(2);
   finalK1Z2_ZQT->SetFrameBorderMode(0);
   finalK1Z2_ZQT->SetFrameFillStyle(0);
   finalK1Z2_ZQT->SetFrameLineWidth(2);
   finalK1Z2_ZQT->SetFrameBorderMode(0);
   ...
   Graph1->SetMinimum(-0.006432095);
   Graph1->SetMaximum(0.07075291);
   ...
   Graph2->SetMinimum(-0.00646343);
   Graph2->SetMaximum(0.07109727);
   ...
   tvis->SetBinContent(1,0.03478568);
   tvis->SetBinContent(2,0.05812053);
   tvis->SetBinContent(3,0.05042504);
   tvis->SetBinContent(4,0.04185792);
   tvis->SetBinContent(5,0.03396763);
   tvis->SetBinContent(6,0.02719711);
   tvis->SetBinContent(7,0.02196022);
   tvis->SetBinContent(8,0.0178621);
   tvis->SetBinContent(9,0.01161779);
   tvis->SetBinContent(10,0.00624871);
   tvis->SetBinContent(11,0.003684551);
   tvis->SetBinContent(12,0.001882464);
   tvis->SetBinContent(13,0.0007946321);
   tvis->SetBinContent(14,0.000362191);
   tvis->SetBinContent(15,0.0001444946);
   tvis->SetBinContent(16,4.863348e-05);
   tvis->SetBinContent(17,1.570369e-05);
   tvis->SetBinContent(18,1.233148e-06);
   tvis->SetBinContent(19,1.240618e-09);
   tvis->SetEntries(19);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   finalK1Z2_ZQT->Modified();
   finalK1Z2_ZQT->cd();
   finalK1Z2_ZQT->SetSelected(finalK1Z2_ZQT);
}
