{
//=========Macro generated from canvas: finalZ2_Zqt/finalZ2_Zqt
//=========  (Wed Jun 22 14:20:06 2011) by ROOT version5.28/00d
   TCanvas *finalZ2_Zqt = new TCanvas("finalZ2_Zqt", "finalZ2_Zqt",0,0,800,600);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   finalZ2_Zqt->SetHighLightColor(2);
   finalZ2_Zqt->Range(-0.6198982,-0.01417621,2.956996,0.07443138);
   finalZ2_Zqt->SetFillColor(0);
   finalZ2_Zqt->SetBorderMode(0);
   finalZ2_Zqt->SetBorderSize(2);
   finalZ2_Zqt->SetLogx();
   finalZ2_Zqt->SetTickx(1);
   finalZ2_Zqt->SetTicky(1);
   finalZ2_Zqt->SetLeftMargin(0.13);
   finalZ2_Zqt->SetRightMargin(0.05);
   finalZ2_Zqt->SetTopMargin(0.05);
   finalZ2_Zqt->SetBottomMargin(0.16);
   finalZ2_Zqt->SetFrameFillStyle(0);
   finalZ2_Zqt->SetFrameLineWidth(2);
   finalZ2_Zqt->SetFrameBorderMode(0);
   finalZ2_Zqt->SetFrameFillStyle(0);
   finalZ2_Zqt->SetFrameLineWidth(2);
   finalZ2_Zqt->SetFrameBorderMode(0);
   ...
   tvis->SetBinContent(1,0.02460261);
   tvis->SetBinContent(2,0.05527316);
   tvis->SetBinContent(3,0.05655785);
   tvis->SetBinContent(4,0.04600471);
   tvis->SetBinContent(5,0.03562974);
   tvis->SetBinContent(6,0.02783039);
   tvis->SetBinContent(7,0.02216917);
   tvis->SetBinContent(8,0.01804608);
   tvis->SetBinContent(9,0.01167498);
   tvis->SetBinContent(10,0.006254892);
   tvis->SetBinContent(11,0.003684267);
   tvis->SetBinContent(12,0.001882658);
   tvis->SetBinContent(13,0.0007947707);
   tvis->SetBinContent(14,0.0003630162);
   tvis->SetBinContent(15,0.0001435128);
   tvis->SetBinContent(16,4.800505e-05);
   tvis->SetBinContent(17,1.558993e-05);
   tvis->SetBinContent(18,1.241694e-06);
   tvis->SetBinContent(19,1.154805e-09);
   tvis->SetEntries(19);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   finalZ2_Zqt->Modified();
   finalZ2_Zqt->cd();
   finalZ2_Zqt->SetSelected(finalZ2_Zqt);
}
