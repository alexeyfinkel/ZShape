{
//=========Macro generated from canvas: finalZQtLog/finalZQtLog
//=========  (Wed Jun 22 13:48:18 2011) by ROOT version5.28/00d
   TCanvas *finalZQtLog = new TCanvas("finalZQtLog", "finalZQtLog",0,0,800,600);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   finalZQtLog->SetHighLightColor(2);
   finalZQtLog->Range(-0.6198982,-6.981287,2.956996,-0.8482436);
   finalZQtLog->SetFillColor(0);
   finalZQtLog->SetBorderMode(0);
   finalZQtLog->SetBorderSize(2);
   finalZQtLog->SetLogx();
   finalZQtLog->SetLogy();
   finalZQtLog->SetTickx(1);
   finalZQtLog->SetTicky(1);
   finalZQtLog->SetLeftMargin(0.13);
   finalZQtLog->SetRightMargin(0.05);
   finalZQtLog->SetTopMargin(0.05);
   finalZQtLog->SetBottomMargin(0.16);
   finalZQtLog->SetFrameFillStyle(0);
   finalZQtLog->SetFrameLineWidth(2);
   finalZQtLog->SetFrameBorderMode(0);
   finalZQtLog->SetFrameFillStyle(0);
   finalZQtLog->SetFrameLineWidth(2);
   finalZQtLog->SetFrameBorderMode(0);
   ...
   Graph13->SetMinimum(-0.006617728);
   Graph13->SetMaximum(0.07279495);
   ...
   Graph24->SetMinimum(-0.006647661);
   Graph24->SetMaximum(0.07312388);
   ...
   truth log->SetBinContent(1,0.02461613);
   truth log->SetBinContent(2,0.05530354);
   truth log->SetBinContent(3,0.05658894);
   truth log->SetBinContent(4,0.04603);
   truth log->SetBinContent(5,0.03564932);
   truth log->SetBinContent(6,0.02784568);
   truth log->SetBinContent(7,0.02218136);
   truth log->SetBinContent(8,0.018056);
   truth log->SetBinContent(9,0.01168139);
   truth log->SetBinContent(10,0.00625833);
   truth log->SetBinContent(11,0.003686292);
   truth log->SetBinContent(12,0.001883693);
   truth log->SetBinContent(13,0.0007952075);
   truth log->SetBinContent(14,0.0003632157);
   truth log->SetBinContent(15,0.0001435917);
   truth log->SetBinContent(16,4.803143e-05);
   truth log->SetBinContent(17,1.55985e-05);
   truth log->SetBinContent(18,1.242376e-06);
   truth log->SetBinContent(19,1.15544e-09);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   finalZQtLog->Modified();
   finalZQtLog->cd();
   finalZQtLog->SetSelected(finalZQtLog);
}
